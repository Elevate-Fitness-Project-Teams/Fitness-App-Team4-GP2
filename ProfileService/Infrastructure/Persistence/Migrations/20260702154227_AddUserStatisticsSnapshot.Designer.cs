...
namespace ProfileService.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260702154227_AddUserStatisticsSnapshot")]
    partial class AddUserStatisticsSnapshot
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProfileService.Domain.Entities.NotificationSetting", b =>
                {
                    b.HasOne("ProfileService.Domain.Entities.UserProfile", "UserProfile")
                        .WithOne()
                        .HasForeignKey("ProfileService.Domain.Entities.NotificationSetting", "UserId")
            ...
            modelBuilder.Entity("ProfileService.Domain.Entities.PrivacySetting", b =>
                {
                    b.HasOne("ProfileService.Domain.Entities.UserProfile", "UserProfile")
                        .WithOne()
                        .HasForeignKey("ProfileService.Domain.Entities.PrivacySetting", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProfileService.Domain.Entities.UserPreference", b =>
                {
                    b.HasOne("ProfileService.Domain.Entities.UserProfile", "UserProfile")
                        .WithOne()
                        .HasForeignKey("ProfileService.Domain.Entities.UserPreference", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
